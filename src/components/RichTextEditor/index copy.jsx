...
const RichTextEditor = ({ className, label, dataRTE, setDataRTE }) => {
  ...
  content?.current?.addEventListener('mouseup', function (e) {
    ...
    if (selection.type === 'Range') {
      ...
      const left =
        rect.left + (rect.right - rect.left) / 2 - box.left - 200 / 2;
      ...
      modalRef.current.style.left =
        (left > 0 ? (left + 200 < box.width ? left : box.width - 200 - 6) : 0) +
        'px';
  ...
  return (
    <div className={className}>
      ...
      >
        ...
        >
          <div className="col-span-12  grid grid-cols-12  sm:col-span-6 border-t-2">
            <input
              type="text"
            ...
            />
            <button className="col-span-1 bg-white border" onClick={handleLink}>
              Link
            </button>
          </div>
        </div>
